...
class LoginControllers {
  ...
  void login() async {
    ...
    if (responseApi?.success ?? false) {
      ...
      if (user.roles.length > 1) {
        TFullScreenLoader.openLoadingDialog( 'Confirmando datos!!', TImages.docerAnimation);
        TFullScreenLoader.openLoadingDialog( 'Datos validados.', TImages.docerAnimation2);
