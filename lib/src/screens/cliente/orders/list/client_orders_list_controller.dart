...
import 'package:delivery_autonoma/src/screens/cliente/orders/detail/client_orders_detail_page.dart';
...
class ClientOrdersListControllers {
      ...
      return BackdropFilter(
        ...
        child: ClipRRect(
          ...
          child: Container(
            ...
            child: ClientOrdersDetailPage(order: order),
          ),
        ),
      );
    },
